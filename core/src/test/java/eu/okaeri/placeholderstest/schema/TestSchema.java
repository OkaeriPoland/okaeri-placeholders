...
public class TestSchema {
    ...
    public void test_read_schema_external_1() {
        ...
        Placeholders placeholders = Placeholders.create()
            .registerPlaceholder(ExternalItem.class, "type", (e, p) -> e.getType())
            .registerPlaceholder(ExternalItem.class, "amount", (e, p) -> e.getAmount())
            .registerPlaceholder(ExternalItem.class, "damage", (e, p) -> e.getDamage())
            .registerPlaceholder(ExternalItem.class, "data", (e, p) -> e.getData())
            .registerPlaceholder(ExternalItem.class, "meta", (e, p) -> e.getMeta())
            .registerPlaceholder(ExternalMeta.class, "name", (e, p) -> e.getName())
            .registerPlaceholder(ExternalMeta.class, "lore", (e, p) -> e.getLore());
    ...
    public void test_read_schema_external_5() {
        ...
        Placeholders placeholders = Placeholders.create()
            ...
            .registerPlaceholder(ExternalMeta.class, "name", (e, p) -> e.getName())
            .registerPlaceholder(ExternalMeta.class, "lore", (e, p) -> e.getLore())
            .registerPlaceholder(ExternalItem.class, "typeEnum", (e, p) -> e.getTypeEnum());
