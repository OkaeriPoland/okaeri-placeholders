...
public class TestPlaceholderUtils {
    ...
    public void test_healthbar_10_of_20() {
        String healthBar = BukkitPlaceholders.renderHealthBarWith(10, 20, '❤');
    ...
    public void test_healthbar_15_of_20() {
        String healthBar = BukkitPlaceholders.renderHealthBarWith(15, 20, '❤');
        assertEquals("§c❤❤❤❤❤❤❤❤❤❤❤❤❤❤❤§7❤❤❤❤❤", healthBar);
        System.out.println(healthBar);
    }
    ...
    public void test_healthbar_0_of_20() {
        String healthBar = BukkitPlaceholders.renderHealthBarWith(0, 20, '❤');
    ...
    public void test_healthbar_20_of_20() {
        String healthBar = BukkitPlaceholders.renderHealthBarWith(20, 20, '❤');
